...
const UpgradeList: React.FC<UpgradeListProps> = ({ upgrades, purchased, playerLevel, currentCoins, onBuy, activeTheme }) => {
  const [activeTab, setActiveTab] = useState<UpgradeCategory>(UpgradeCategory.CLICK_POWER);
